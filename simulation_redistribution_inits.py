...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 18 17:12:09 2020
...
with open("result/edge_densities_20.pkl","rb") as f:
    
    edge_densities_20 = pickle.load(f)
...
def optimize_redistribution_initStrategy():
    ...
    minfits = [] #record minimal fitnesses of every generation
    meanfits = [] # record average fitnesses of every generation
    maxfits = [] #record maximal fitnesses of every generation
    ...
    with open("minfits_initStrategy.pkl","wb") as f:
        pickle.dump(minfits, f)
    
    with open("meanfits_initStrategy.pkl","wb") as f:
        pickle.dump(meanfits, f)
        
    with open("maxfits_initStrategy.pkl","wb") as f:
        pickle.dump(maxfits, f)
    
    return minfits,meanfits,maxfits


minfits,meanfits,maxfits = optimize_redistribution_initStrategy()
