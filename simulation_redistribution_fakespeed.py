...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 18 11:45:04 2020
...
# objective function
def simulation__shortest_redistribution_fakespeed(w):
    """
    # objective function
    args:
...
toolbox.register("evaluate", simulation__shortest_redistribution_fakespeed)
...
def optimize_redistribute_fakespeed():
    ...
    with open("min_fitnesses_redistribution_fakespeed.pkl", "wb") as f:
        pickle.dump(min_fitnesses, f)

    with open("max_fitnesses_redistribution_fakespeed.pkl","wb") as f:
        pickle.dump(max_fitnesses, f)

    with open("mean_fitnesses_redistribution_fakespeed.pkl","wb") as f:
        pickle.dump(mean_fitnesses, f)
        
    return min_fitnesses, mean_fitnesses, max_fitnesses


optimize_redistribute_fakespeed()